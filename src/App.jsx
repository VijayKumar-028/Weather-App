...
import { convertTemperature, getHumidityValue, getVisibilityValue } from './components/Helper';
import { HumidityIcon, SunriseIcon, SunsetIcon, VisibilityIcon, WindIcon } from './components/Icon';
import Weatherbg from './components/Weatherbackground';
...
const App = () => {
  ...
  const API_KEY = "bdcbed291dd3a5929e9afad26b96c972";
          ...
          {!weather ? (
            <form onSubmit={handleSearch} className="flex flex-col relative">
              <input
                ...
                placeholder="Enter city or country (min 3 letters) to get weather details"
                className="mb-4 p-3 rounded border border-white bg-transparent text-white placeholder-gray-400 focus:outline-none focus:border-blue-300 transition duration-300"
              />
              {suggestion.length > 0 && (
            ...
            <div className="mt-6 text-center transition-opacity duration-500">
              ...
              <div className="flex flex-wrap justify-around mt-6">
                {[
                  ...
                  <div key={label} className="flex items-center flex-col m-2">
                    <Icon />
                    <p className="mt-1 font-semibold">{label}</p>
                    <p className="text-sm">
